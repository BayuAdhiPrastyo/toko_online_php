<?php
    ...
    $jumlahKategori = mysqli_num_rows($queryKateogri);
                    ...
                    <div class="summary-kategori p-3">
                        <div class="row">
                            ...
                            <div class="col-6 text-white">
                                ...
                                <p><a href="kategori.php" class="text-white no-decoration">Lihat Detail</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="summary-produk p-3">
                        <div class="row">
                            ...
                            <div class="col-6 text-white">
                                ...
                                <p><a href="produk.php" class="text-white no-decoration">Lihat Detail</p>
                            </div>
                        </div>
                    </div>
                </div>
