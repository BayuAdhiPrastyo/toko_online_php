            ...
            <?php
                if(isset($_POST['simpan'])){
                    ...
                    if($nama=='' || $kategori=='' || $harga==''){
                        ...
                        if($nama_file!=''){
                            if($image_size > 500000){
                                ...
                                if($imageFileType != 'jpg' && $imageFileType != 'png' && $imageFileType != 'gif' && $imageFileType !='jpeg'){
                                    ?>
                                        <div class="alert alert-warning mt-3" role="alert">
                                            File wajib bertipe jpg atau png atau gif atau jpeg
                                        </div>
                                    <?php
                                }
                                else{
                        ...
                        $queryTambah = mysqli_query($con, "INSERT INTO produk (kategori_id, nama, 
                        harga, foto, detail, ketersediaan_stok) VALUES ('$kategori', '$nama', '$harga', 
